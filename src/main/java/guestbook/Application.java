...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "a@test.com", "first!!!"), //
					new GuestbookEntry("Arni", "arni@arni.de", "Hasta la vista, baby"), //
					new GuestbookEntry("Duke Nukem", "nuki@googlemail.com", "It's time to kick ass and chew bubble gum. And I'm all out of gum."), //
					new GuestbookEntry("Gump1337", "gg@google.de",
